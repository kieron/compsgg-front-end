  ...
  <nav id="header" class="w-full z-30 top-0 text-white bg-middle">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
      <div class="pl-4 flex items-center">
        ...
        <router-link :to="'/'" class="toggleColour text-indigo-100 no-underline hover:no-underline font-bold text-2xl lg:text-4xl tracking-wider uppercase header-font">Comps.gg</router-link>
