    ...
    <div class="pt-8">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <div class="flex flex-col w-full md:w-4/5 justify-center items-start text-center md:text-left">
          <h1 class="my-4 text-3xl md:text-5xl font-bold leading-tight text-indigo-100 tracking-widest">
            Find the best giveaways & competitions
          </h1>
          <p class="leading-normal text-xl md:text-2xl text-indigo-100">
            Stop wasting time searching through spam websites & suspicious
            links, use comps.gg to find the best legitimate giveaways from all
            over the web.
          </p>
