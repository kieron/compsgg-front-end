	...
	<div class="text-indigo-100 about">
		<section class="px-4 py-5 bg-middle md:bg-primary md:px-8">
			...
			>
				...
				<p>
					Register on Comps.gg to start saving your competition entry
					history!
				</p>
				<div class="providers flex flex-col pt-5">
					...
					>
						...
						<span class="pl-3"
							>Sign up with {{ capitalize(provider) }}</span
						>
					</a>
				</div>
				...
				<p class="mb-1">
					Rest assured, you can continue to use Comps.gg as anonymously as
					you'd like too. However, if you do choose to register, when you
					mark a competition as complete, we can save that information to
					your account, so you can continue from any device at all, making
					it easier than ever to get entering competitions.
				</p>
			</div>
		</section>
	</div>
...
export default {
	...
	metaInfo() {
		return {
			title: "Register | Comps.gg",
			meta: [
				{
					name: "description",
					content:
						this.metaTitle +
						"Register with Comps.gg. Find Competitions & Giveaways from all over the web.",
				},
			],
		};
	},
